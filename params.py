...
params4noma = copy.deepcopy(params2users)
params4noma['group_definition_path'] = 'data/group_definition_noma_training.npy'
params4noma['group_definition_testing_path'] = 'data/group_definition_noma_testing.npy'
...
# For 2x2 sensors
# params4users["indices_sensors"] = [8, 26]